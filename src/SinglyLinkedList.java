...
public void swapTwoNodes(String node1, String node2){
	...
	Node<E> prevNode1 = null, currNode1 = head; 
    ...
    Node<E> prevNode2 = null, currNode2 = head; 
    ...
    if (currNode1 == null || currNode2 == null){
    	if(currNode1 == null)
    		System.out.println("\n" + node1 +" is not in Linked List ");
    	if(currNode2 == null)
            System.out.println(node2 +" is not in Linked List ");
    	System.out.println("Error!!! Cannot swap two nodes.");
        return;
      } 
